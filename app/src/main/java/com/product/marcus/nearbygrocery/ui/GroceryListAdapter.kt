 ...
 */
class GroceryListAdapter(private val context: Context, private val data: List<Result>, private val listener: OnItemClickListener) : RecyclerView.Adapter<GroceryListAdapter.ViewHolder>() {
